...
_PRE_CONTEXT_SUMMARIES_REVISION = "041"
...
def _with_markdown_source_gaps(
    ...
    merged["novel_context_summaries"] = _missing_table_gap("novel_context_summaries")
    return merged


_UNVERSIONED_AUTO_UPGRADE_BASELINES: tuple[tuple[str, dict[str, set[str]]], ...] = (
    (
        _PRE_CONTEXT_SUMMARIES_REVISION,
        {"novel_context_summaries": _missing_table_gap("novel_context_summaries")},
    ),
    (
