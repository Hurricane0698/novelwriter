; NovWr vendored template provenance:
...
Function .onInit
  ...
  !if "${INSTALLMODE}" == "currentUser"
    StrCpy $INSTDIR "$LOCALAPPDATA\${PRODUCTNAME}\app"
  !else
...
Section Uninstall
  ...
  ; Remove installer-owned metadata while preserving user data outside $INSTDIR.
  ${If} $UpdateMode <> 1
